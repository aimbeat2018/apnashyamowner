                ...
                children: [
                  ...
                  homeController.isLoading &&
                    ...
                    child: CircularProgressIndicator(),
                      ...
                      :helpQuestionAnswersResponseModel!.data==null? const Center(
                    child: CircularProgressIndicator(),
                  )
                      :helpQuestionAnswersResponseModel!.data!.list==null? const Center(
                    child: CircularProgressIndicator(),
                  )
                      : ListView.builder(
                        shrinkWrap: true,
                        itemCount: helpQuestionAnswersResponseModel!.data!.list!.length,
                        itemBuilder: (BuildContext context, int index) {
                          return Padding(
                            ...
                            child: ProfileSections(
                                onTap: () =>
                                    Navigator.pushNamed(
                                        context, MyRoutes.answerScreen,
                                        arguments: [helpQuestionAnswersResponseModel!.data!.list![index].question!,helpQuestionAnswersResponseModel!.data!.list![index].answer!],
                                    ),
                                label: helpQuestionAnswersResponseModel!.data!.list![index].question!),);
                        },
                      ),
                  SizedBox(
                    height: 8.r,
