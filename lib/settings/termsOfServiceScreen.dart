...
class TermsOfServiceScreen extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => TermsOfServiceScreenState();
}
        ...
        body: _connectionStatus == AppConstants.connectivityCheck
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                const CustomTitle(title: 'Terms of service'),
                SizedBox(
                  height: 20.r,
                ),
                homeController.isLoading &&
                  ...
                  child: CircularProgressIndicator(),
                    ...
                    :tnCPrivacyPolicyResponseModel!.data==null?
                const Center(
                  child: CircularProgressIndicator(),
                )
                    :tnCPrivacyPolicyResponseModel!.data!.detail==null?
                const Center(
                  child: CircularProgressIndicator(),
                )
                    : Card(
